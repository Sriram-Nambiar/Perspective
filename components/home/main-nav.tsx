      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 py-3.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-1.5 rounded-lg text-[#111827] hover:bg-[#F3F4F6] transition-colors cursor-pointer"
          ...
          <div className="flex items-center gap-2.5 cursor-pointer">
            ...
            <div className="flex flex-col">
              <span className="text-[20px] md:text-[22px] font-black tracking-tight text-[#0D0D0F] leading-none uppercase font-sans">
                PERSPECTIVE
              </span>
              <span className="text-[9px] md:text-[10px] text-[#6B7280] font-medium leading-tight tracking-tight mt-0.5">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            type="button"
            className="bg-[#0D0D0F] hover:bg-[#27272A] text-white text-[13px] font-medium px-4 sm:px-5 py-2 rounded-[6px] transition-colors cursor-pointer shadow-xs"
          >
            Subscribe
          </button>
          <button
            type="button"
            className="bg-white hover:bg-[#F9FAFB] text-[#0D0D0F] border border-[#D1D5DB] text-[13px] font-medium px-4 sm:px-5 py-2 rounded-[6px] transition-colors cursor-pointer"
          >
            Login
          </button>
        </div>
